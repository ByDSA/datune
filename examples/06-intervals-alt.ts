...
console.log("between", // Shortest interval
  ...
  I.between(P.fromDiatonicAlts(DP.C, -4), P.fromDiatonicAlts(DP.C, 4)) // -> null (not calculated, Cbbbb to C#### is unused interval)
);
...
// Conversion
console.log("toChromaticInterval",
...
console.log("cyclic", // Only positive intervals between unison to octave
