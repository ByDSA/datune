...
export function stringifyShortNameLang(voicing: Voicing, options?: Options): string | null {
  ...
  switch (voicing) {
    // Interval
    case m2: return lang.shortVoicings.m2;
    case M2: return lang.shortVoicings.M2;
    case m3: return lang.shortVoicings.m3;
    case M3: return lang.shortVoicings.M3;
    ...
    case fromRootIntervals(0, 1, 6): return "loc∆";// TODO: mover a lang estos nombres
    case fromRootIntervals(0, 1, 7): return "phryg∆";
    case fromRootIntervals(0, 2, 5): return "sus2/4";
    case fromRootIntervals(0, 2, 6): return "sus2♭5";
    case fromRootIntervals(0, 2, 8): return "sus2♯5";
    case fromRootIntervals(0, 3, 5): return "m∆sus4";
    case fromRootIntervals(0, 4, 5): return "∆sus4";
    case fromRootIntervals(0, 4, 6): return "♭5";
    case fromRootIntervals(0, 5, 6): return "sus4♭5";
    case fromRootIntervals(0, 5, 8): return "sus4♯5";
    case fromRootIntervals(0, 6, 7): return "lyd∆";
      // 7ª
