...
export default function toStringShort(voicing: Voicing, options?: Options): string {
  ...
  switch (voicing) {
    ...
    default: return arrayStringify(voicing.rootIntervals);
  }
}
