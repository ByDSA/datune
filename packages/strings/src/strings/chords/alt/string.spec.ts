...
describe.each([
  ...
  [LangId.EN, Chords.fromPitches(P.C, P.Db, P.Eb), "C(1,♭2,♭3)"],
  [LangId.EN, Chords.fromPitches(P.C, P.E, P.Gb), "C♭5"],
  [LangId.EN, Chords.fromPitches(P.C, P.CC, P.Gb), "C(1,♯1,♭5)"],
  [LangId.EN, Chords.fromPitches(P.C, P.Db, P.Gb), "Cloc∆"],
  [LangId.EN, Chords.fromPitches(P.C, P.FF, P.G), "Clyd∆"],
  [LangId.EN, Chords.fromPitches(P.C, P.Gb, P.G), "C(1,♭5,5)"],
