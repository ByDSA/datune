declare module "midi-file" {
  ...
  export interface MidiTextEvent extends MidiMetaEvent {
    type: "cuePoint" | "lyrics" | "marker" | "text";
    text: string;
  }
  ...
  export type MidiTrackEvent = MidiControllerEvent | MidiEndOfTrackEvent | MidiInstrumentEvent | MidiKeySignatureEvent | MidiNoteOffEvent | MidiNoteOnEvent | MidiPitchBendEvent | MidiTempoEvent | MidiTextEvent | MidiTimeSignatureEvent | MidiTrackNameEvent;
  ...
  // EXPORTED METHODS
  // //////////////////////////////////////////////////////
  export function parseMidi(midiArray: ArrayBuffer | ArrayLike<number>): MidiData;
