...
import * as CIntervals from "intervals/symbolic/chromatic/constants";
import * as RIntervals from "intervals/real/constants";
import { TestInit } from "tests";

const { DIMINISHED_FIFTH, MAJOR_SECOND, MAJOR_SEVENTH, MAJOR_SIXTH, MAJOR_THIRD, MINOR_SECOND, MINOR_SEVENTH, MINOR_SIXTH, MINOR_THIRD, PERFECT_FIFTH, PERFECT_FOURTH, PERFECT_OCTAVE, PERFECT_UNISON } = CIntervals;

TestInit.chromaticTemperament();
const { ET12_PERFECT_FIFTH, ET12_PERFECT_FOURTH, J_DIMINISHED_FIFTH, J_MAJOR_SEVENTH, J_MAJOR_SIXTH, J_MAJOR_THIRD, J_MAJOR_TONE, J_MINOR_SECOND, J_MINOR_SEVENTH_GREATER, J_MINOR_SEVENTH_SMALL, J_MINOR_SIXTH, J_MINOR_THIRD, J_MINOR_TONE, J_PERFECT_FIFTH, J_PERFECT_FOURTH, OCTAVE, PT_DIMINISHED_FIFTH, PT_MAJOR_SECOND, PT_MAJOR_SEVENTH, PT_MAJOR_SIXTH, PT_MAJOR_THIRD, PT_MINOR_SECOND, PT_MINOR_SEVENTH, PT_MINOR_SIXTH, PT_MINOR_THIRD, PT_PERFECT_FIFTH, PT_PERFECT_FOURTH, UNISON } = RIntervals;
