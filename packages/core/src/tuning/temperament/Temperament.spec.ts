import { IntervalDiatonicAlt, IntervalPitch } from "../../intervals";
import { DiatonicAlt } from "../../pitches";
import { Temperament } from "./Temperament";

test('EQUAL - root ratio - Chromatic.C', () => {
    let noteAlt = DiatonicAlt.C;
    let root = DiatonicAlt.C;

    let intervalDiatonicAlt: IntervalDiatonicAlt = IntervalDiatonicAlt.between(root, noteAlt);
...
test('EQUAL - root ratio - chromatic= DiatonicAlt.C, root = DiatonicAlt.G', () => {
    let noteAlt = DiatonicAlt.C;
...
test('EQUAL - root ratio - chromatic= DiatonicAlt.CCC, root = DiatonicAlt.GGG', () => {
    let noteAlt = DiatonicAlt.CCC;
