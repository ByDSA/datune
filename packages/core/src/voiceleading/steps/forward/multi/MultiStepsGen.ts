...
import { StepReason } from "../../../../voiceleading/steps/reason/StepReason";
import { StepType } from "../../../../voiceleading/steps/reason/StepType";
import { StepOrNull } from "../../../../voiceleading/steps/Step";
...
export class MultiStepsGen {
    ...
    requirePatternResolution(): MultiStepsGen {
