...
import { ScaleCache } from "../../scales/symbolic/chromatic/scale/building/cache/ScaleCache";
import { Initializer } from "../initializer/Initializer";
import { MainInit } from "../main/MainInit";
import { ScaleData, ScaleSingleData } from "./data/ScaleData";

export class ScaleInit extends Initializer<ScaleData> {
...
function _map2TonalityData(): ScaleData {
